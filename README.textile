...
on OS X:
* install Xcode 6.2+, Xquartz, SDL2, SDL2_image, CUDA (optionally) and boost (copying headers to /usr/local/include or /usr/include suffices)
...
* to disable CUDA: define "FLOOR_NO_CUDA"
