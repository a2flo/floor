...
* install all necessary libraries and programs, including clang 3.3+ and libc++ (currently 1101) (-> Credits)
...
on Windows/MinGW:
* install custom MinGW builds (with clang 3.3+ and libc++)
...
* if you haven't installed the Xcode command line tools yet, run: bc. xcode-select --install
