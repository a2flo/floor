...
*Installation (Unix):*
* sudo ln -sf /path/to/floor/bin/libfloor{,d}.{so,dylib} /usr/lib/
* sudo ln -sf /path/to/floor/bin/libfloor{,d}_static.a /usr/lib/
...
** add "floor/etc/llvm35/compute_clang_*_*/" to your PATH environment variable, or set fixed/absolute binary paths in config.json
** "floor/etc/llvm35/compute_clang_*_*/libcxx/include" and "floor/etc/llvm35/compute_clang_*_*/clang" must be set in your config.json (provided by a project using floor)
