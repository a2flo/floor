...
*Requirements:*
* OS:
** Windows: NT 6.0+ (MSVC: x86/32-bit only, MinGW/MSYS2: x64/64-bit only)
...
* inside this folder:
** create a "lib" folder and copy floor.lib/floord.lib (MSVC) / libfloor_static.a/libfloord_static.a (MinGW/MSYS2) there
