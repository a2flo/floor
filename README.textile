...
** to disable Metal (only affects iOS builds):
...
** to disable language support (lexer/parser):
   define "FLOOR_NO_LANG" or "./build.sh no-lang"
** to disable C++ exceptions (implies no-net no-lang):
