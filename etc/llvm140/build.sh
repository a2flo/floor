...
# download src
LLVM_REV=e98c6e479f7f042cf42b6fc66f357b50fe25714c
LLVM_SPIRV_REV=a515cd501a5798b6c8e742da7b629b15adcf33ce
if [ ! -d llvm ]; then
...
if [ $BUILD_OS == "macos" ]; then
	APPLE_DEPLOYMENT_TARGET="-DCMAKE_OSX_DEPLOYMENT_TARGET=15.6"
	APPLE_ARCHS="-DCMAKE_OSX_ARCHITECTURES=x86_64;arm64"
	CPU_OPTIONS=""
elif [ $BUILD_OS == "ios" ]; then
	APPLE_DEPLOYMENT_TARGET="-DCMAKE_OSX_DEPLOYMENT_TARGET=18.6 -DCMAKE_SYSTEM_NAME=iOS"
