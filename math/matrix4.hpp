...
public:
	...
	constexpr FLOOR_DEVICE matrix4() noexcept :
	data({{
		(T)1, (T)0, (T)0, (T)0,
		(T)0, (T)1, (T)0, (T)0,
		(T)0, (T)0, (T)1, (T)0,
		(T)0, (T)0, (T)0, (T)1}}) {}
	constexpr FLOOR_DEVICE matrix4(const T& val) noexcept :
	data({{
		val, val, val, val,
		val, val, val, val,
		val, val, val, val,
		val, val, val, val}}) {}
	constexpr FLOOR_DEVICE matrix4(matrix4&& m4) noexcept : data(m4.data) {}
	constexpr FLOOR_DEVICE matrix4(const matrix4<T>& m4) noexcept : data(m4.data) {}
	constexpr FLOOR_DEVICE matrix4(const matrix4<T>* m4) noexcept : data(m4->data) {}
	constexpr FLOOR_DEVICE matrix4(const T& m0, const T& m1, const T& m2, const T& m3,
	...
	constexpr FLOOR_DEVICE matrix4(const vector4<T>& col_0,
	...
	template <typename U> constexpr FLOOR_DEVICE matrix4(const matrix4<U>& mat4) noexcept :
	data({{
