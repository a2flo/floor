...
#define FLOOR_BUILD_VERSION_STRINGIFY(ver) #ver
#define FLOOR_BUILD_VERSION_EVAL(ver) FLOOR_BUILD_VERSION_STRINGIFY(ver)
#define FLOOR_BUILD_VERSION_STR FLOOR_BUILD_VERSION_EVAL(FLOOR_BUILD_VERSION)
#define FLOOR_COMPAT_VERSION FLOOR_MAJOR_VERSION "." FLOOR_MINOR_VERSION "." FLOOR_REVISION_VERSION
#define FLOOR_FULL_VERSION FLOOR_COMPAT_VERSION FLOOR_DEV_STAGE_VERSION "-" FLOOR_BUILD_VERSION_STR
