...
#define FLOOR_FULL_VERSION FLOOR_MAJOR_VERSION "." FLOOR_MINOR_VERSION "." FLOOR_REVISION_VERSION FLOOR_DEV_STAGE_VERSION
...
" v"+(FLOOR_FULL_VERSION)+"-"+size_t2string(FLOOR_BUILD_VERSION)+\
