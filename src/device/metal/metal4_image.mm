...
bool metal4_image::blit_internal(const bool is_async, const device_queue& cqueue, const device_image& src,
...
bool metal4_image::blit(const device_queue& cqueue, const device_image& src) {
	return blit_internal(false, cqueue, src, {}, {});
}

bool metal4_image::blit_async(const device_queue& cqueue, const device_image& src,
