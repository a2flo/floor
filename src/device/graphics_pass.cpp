...
static std::optional<render_pass_description> multi_view_pass_modification(const render_pass_description& pass_desc) {
...
pass_desc(pass_desc_), multi_view_pass_desc(with_multi_view_support && pass_desc_.automatic_multi_view_handling ?
											multi_view_pass_modification(pass_desc_) : std::nullopt), multi_view_capable(with_multi_view_support) {
