...
public:
	metal_image(metal_device* floor_nonnull device,
	...
	void* floor_nullable __attribute__((aligned(128))) map(shared_ptr<compute_queue> cqueue,
														   const COMPUTE_MEMORY_MAP_FLAG flags =
														   (COMPUTE_MEMORY_MAP_FLAG::READ_WRITE |
															COMPUTE_MEMORY_MAP_FLAG::BLOCK)) override;
	
	void unmap(shared_ptr<compute_queue> cqueue,
...
protected:
	...
	bool create_internal(const bool copy_host_data, const metal_device* floor_nonnull device);
