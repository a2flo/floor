...
#define FLOOR_RT_WRITE_IMAGE_CASE(write_func, rt_base_type) case rt_base_type: { \
	...
	floor_inline_always static void write_float(const uint64_t surf, const COMPUTE_IMAGE_TYPE runtime_image_type,
		...
		switch(runtime_base_type) {
			FLOOR_RT_WRITE_IMAGE_CASE(write_imagef,
	...
	floor_inline_always static void write_int(const uint64_t surf, const COMPUTE_IMAGE_TYPE runtime_image_type,
		...
		const auto runtime_base_type = runtime_image_type & (COMPUTE_IMAGE_TYPE::__FORMAT_MASK |
															 COMPUTE_IMAGE_TYPE::__DATA_TYPE_MASK);
		switch(runtime_base_type) {
			FLOOR_RT_WRITE_IMAGE_CASE(write_imagei, COMPUTE_IMAGE_TYPE::FORMAT_8 | COMPUTE_IMAGE_TYPE::INT)
			FLOOR_RT_WRITE_IMAGE_CASE(write_imagei, COMPUTE_IMAGE_TYPE::FORMAT_16 | COMPUTE_IMAGE_TYPE::INT)
			FLOOR_RT_WRITE_IMAGE_CASE(write_imagei, COMPUTE_IMAGE_TYPE::FORMAT_24 | COMPUTE_IMAGE_TYPE::INT)
			FLOOR_RT_WRITE_IMAGE_CASE(write_imagei, COMPUTE_IMAGE_TYPE::FORMAT_32 | COMPUTE_IMAGE_TYPE::INT)
			default: floor_unreachable();
		}
	}
	...
	floor_inline_always static void write_uint(const uint64_t surf, const COMPUTE_IMAGE_TYPE runtime_image_type,
		...
		const auto runtime_base_type = runtime_image_type & (COMPUTE_IMAGE_TYPE::__FORMAT_MASK |
															 COMPUTE_IMAGE_TYPE::__DATA_TYPE_MASK);
		switch(runtime_base_type) {
			FLOOR_RT_WRITE_IMAGE_CASE(write_imageui, COMPUTE_IMAGE_TYPE::FORMAT_8 | COMPUTE_IMAGE_TYPE::UINT)
			FLOOR_RT_WRITE_IMAGE_CASE(write_imageui, COMPUTE_IMAGE_TYPE::FORMAT_16 | COMPUTE_IMAGE_TYPE::UINT)
			FLOOR_RT_WRITE_IMAGE_CASE(write_imageui, COMPUTE_IMAGE_TYPE::FORMAT_24 | COMPUTE_IMAGE_TYPE::UINT)
			FLOOR_RT_WRITE_IMAGE_CASE(write_imageui, COMPUTE_IMAGE_TYPE::FORMAT_32 | COMPUTE_IMAGE_TYPE::UINT)
			default: floor_unreachable();
		}
	}
