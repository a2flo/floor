...
class metal4_buffer;
class metal_device;
class metal4_function_entry;

class metal4_function : public device_function {
public:
	using function_map_type = fl::flat_map<const metal_device*, std::shared_ptr<metal4_function_entry>>;
	
	metal4_function(const std::string_view function_name_, function_map_type&& functions);
	~metal4_function() override = default;
