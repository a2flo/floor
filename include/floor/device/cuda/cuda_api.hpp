...
enum class CU_RESULT : uint32_t {
	...
	CONTAINED = 226,
	INSUFFICIENT_LOADER_VERSION = 227,
	INVALID_SOURCE = 300,
	FILE_NOT_FOUND = 301,
	...
	KEY_ROTATION = 916,
	STREAM_DETACHED = 917,
	GRAPH_RECAPTURE_FAILURE = 918,
	FABRIC_NOT_READY = 919,
	UNKNOWN = 999
};
enum class CU_DEVICE_ATTRIBUTE : uint32_t {
	...
	// CUDA 13.4+
	LOCALITY_DOMAIN_COUNT = 149,
	MAX_OVERSIZED_SHARED_MEMORY_PER_BLOCK = 150,
	// CUDA 13.3+
	...
	// CUDA 13.4+
	LOCALITY_DOMAIN_MULTIPROCESSOR_COUNT = 157,
	LOGICAL_ENDPOINT_SUPPORTED_HANDLE_TYPES = 158,
	GPU_DIRECT_RDMA_WITH_LOCALIZED_MEMORY_SUPPORTED = 159,
};
enum class CU_FUNCTION_ATTRIBUTE : uint32_t {
	...
	// CUDA 13.3+
	DEVICE_NODE_UPDATE_SUPPORTED = 16,
	// CUDA 13.4+
	SHARED_MEMORY_MODE = 17,
};
...
enum class CU_ARRAY_FORMAT : uint32_t {
	...
	// CUDA 13.1+
	UINT8_PACKED_422 = 0x51,
	UINT8_PACKED_444 = 0x52,
	UINT8_SEMIPLANAR_420 = 0x53,
	UINT16_SEMIPLANAR_420 = 0x54,
	UINT8_SEMIPLANAR_422 = 0x55,
	UINT16_SEMIPLANAR_422 = 0x56,
	UINT8_SEMIPLANAR_444 = 0x57,
	UINT16_SEMIPLANAR_444 = 0x58,
	UINT8_PLANAR_420 = 0x59,
	UINT16_PLANAR_420 = 0x5A,
	UINT8_PLANAR_422 = 0x5B,
	UINT16_PLANAR_422 = 0x5C,
	UINT8_PLANAR_444 = 0x5D,
	UINT16_PLANAR_444 = 0x5E,
};
...
enum class CU_LAUNCH_ATTRIBUTE_PORTABLE_CLUSTER_MODE {
	...
	// CUDA 13.4+
	ALLOW_OVERSIZED_SHARED_MEMORY = 3,
	PREFER_OVERSIZED_SHARED_MEMORY = 4,
};
