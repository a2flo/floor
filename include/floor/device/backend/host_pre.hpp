...
#if defined(FLOOR_DEVICE_HOST_COMPUTE_IS_DEVICE) // device toolchain
...
// these would usually be set through toolchain at compile-time
...
#define FLOOR_DEVICE_INFO_VENDOR HOST
#define FLOOR_DEVICE_INFO_VENDOR_HOST
#define FLOOR_DEVICE_INFO_PLATFORM_VENDOR HOST
#define FLOOR_DEVICE_INFO_PLATFORM_VENDOR_HOST
#define FLOOR_DEVICE_INFO_TYPE CPU
#define FLOOR_DEVICE_INFO_TYPE_CPU

#if defined(__APPLE__)
#if defined(FLOOR_IOS)
#define FLOOR_DEVICE_INFO_OS IOS
#define FLOOR_DEVICE_INFO_OS_IOS
#elif defined(FLOOR_VISIONOS)
#define FLOOR_DEVICE_INFO_OS VISIONOS
#define FLOOR_DEVICE_INFO_OS_VISIONOS
#else
#define FLOOR_DEVICE_INFO_OS OSX
#define FLOOR_DEVICE_INFO_OS_OSX
#endif
#elif defined(__WINDOWS__)
#define FLOOR_DEVICE_INFO_OS WINDOWS
#define FLOOR_DEVICE_INFO_OS_WINDOWS
#elif defined(__LINUX__)
#define FLOOR_DEVICE_INFO_OS LINUX
#define FLOOR_DEVICE_INFO_OS_LINUX
#elif defined(__FreeBSD__)
#define FLOOR_DEVICE_INFO_OS FREEBSD
#define FLOOR_DEVICE_INFO_OS_FREEBSD
#elif defined(__OpenBSD__)
#define FLOOR_DEVICE_INFO_OS OPENBSD
#define FLOOR_DEVICE_INFO_OS_OPENBSD
#else
#define FLOOR_DEVICE_INFO_OS UNKNOWN
#define FLOOR_DEVICE_INFO_OS_UNKNOWN
#endif
...
#elif FLOOR_DEVICE_INFO_OS_VERSION >= 260000 && FLOOR_DEVICE_INFO_OS_VERSION < 270000
#define FLOOR_DEVICE_INFO_OS_VERSION_260000
#elif FLOOR_DEVICE_INFO_OS_VERSION >= 270000
#define FLOOR_DEVICE_INFO_OS_VERSION_270000
#endif

#elif defined(FLOOR_VISIONOS) // visionOS
#define FLOOR_DEVICE_INFO_OS_VERSION __VISION_OS_VERSION_MAX_ALLOWED

#if FLOOR_DEVICE_INFO_OS_VERSION < 20000
#error "invalid OS version"
#elif FLOOR_DEVICE_INFO_OS_VERSION >= 20000 && FLOOR_DEVICE_INFO_OS_VERSION < 260000
#define FLOOR_DEVICE_INFO_OS_VERSION_20000
#elif FLOOR_DEVICE_INFO_OS_VERSION >= 260000 && FLOOR_DEVICE_INFO_OS_VERSION < 270000
#define FLOOR_DEVICE_INFO_OS_VERSION_260000
#elif FLOOR_DEVICE_INFO_OS_VERSION >= 270000
#define FLOOR_DEVICE_INFO_OS_VERSION_270000
...
#endif
#else // all else
#define FLOOR_DEVICE_INFO_OS_VERSION 0
#define FLOOR_DEVICE_INFO_OS_VERSION_0
#endif
...
#define FLOOR_DEVICE_INFO_HAS_FMA 0
#define FLOOR_DEVICE_INFO_HAS_FMA_0

// these are always set, as all targets (x86/arm) should/must support these
#define FLOOR_DEVICE_INFO_HAS_64_BIT_ATOMICS 1
#define FLOOR_DEVICE_INFO_HAS_64_BIT_ATOMICS_1
#define FLOOR_DEVICE_INFO_HAS_NATIVE_EXTENDED_64_BIT_ATOMICS 1
#define FLOOR_DEVICE_INFO_HAS_NATIVE_EXTENDED_64_BIT_ATOMICS_1
// not natively supported or exposed right now
#define FLOOR_DEVICE_INFO_HAS_32_BIT_FLOAT_ATOMICS 0
#define FLOOR_DEVICE_INFO_HAS_32_BIT_FLOAT_ATOMICS_0

// local memory is emulated through global ("normal") memory, although almost certainly cached
#define FLOOR_DEVICE_INFO_HAS_DEDICATED_LOCAL_MEMORY 0
...
#define FLOOR_DEVICE_INFO_HAS_SUB_GROUP_SHUFFLE 1
...
#define FLOOR_DEVICE_INFO_HAS_COOPERATIVE_KERNEL_0

// Host-Compute doesn't support primitive ID or barycentric coordinates
#define FLOOR_DEVICE_INFO_HAS_PRIMITIVE_ID 0
...
#define FLOOR_DEVICE_INFO_HAS_IMAGE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_DEPTH_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_DEPTH_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_DEPTH_WRITE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_DEPTH_WRITE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_SUPPORT 0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_SUPPORT_0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_WRITE_SUPPORT 0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_WRITE_SUPPORT_0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_ARRAY_SUPPORT 0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_ARRAY_SUPPORT_0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_ARRAY_WRITE_SUPPORT 0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MSAA_ARRAY_WRITE_SUPPORT_0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_WRITE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_WRITE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_ARRAY_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_ARRAY_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_ARRAY_WRITE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_CUBE_ARRAY_WRITE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MIPMAP_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MIPMAP_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MIPMAP_WRITE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_MIPMAP_WRITE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_OFFSET_READ_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_OFFSET_READ_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_OFFSET_WRITE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_OFFSET_WRITE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_DEPTH_COMPARE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_DEPTH_COMPARE_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_GATHER_SUPPORT 0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_GATHER_SUPPORT_0
#define FLOOR_DEVICE_INFO_HAS_IMAGE_READ_WRITE_SUPPORT 1
#define FLOOR_DEVICE_INFO_HAS_IMAGE_READ_WRITE_SUPPORT_1

#define FLOOR_DEVICE_INFO_MAX_MIP_LEVELS 16u

// indirect command info
#define FLOOR_DEVICE_INFO_INDIRECT_COMMAND_SUPPORT 1
#define FLOOR_DEVICE_INFO_INDIRECT_COMMAND_SUPPORT_1
#define FLOOR_DEVICE_INFO_INDIRECT_COMPUTE_COMMAND_SUPPORT 1
#define FLOOR_DEVICE_INFO_INDIRECT_COMPUTE_COMMAND_SUPPORT_1
#define FLOOR_DEVICE_INFO_INDIRECT_RENDER_COMMAND_SUPPORT 0
#define FLOOR_DEVICE_INFO_INDIRECT_RENDER_COMMAND_SUPPORT_0

// tessellation info
#define FLOOR_DEVICE_INFO_TESSELLATION_SUPPORT 0
...
#define FLOOR_DEVICE_INFO_HAS_ARGUMENT_BUFFER_SUPPORT_1
#define FLOOR_DEVICE_INFO_HAS_ARGUMENT_BUFFER_IMAGE_SUPPORT 0
#define FLOOR_DEVICE_INFO_HAS_ARGUMENT_BUFFER_IMAGE_SUPPORT_0
