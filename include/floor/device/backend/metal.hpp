...
namespace std {
	...
	const_func floor_inline_always metal_func float copysign(float a, float b) {
		...
		return std::bit_cast<float>((std::bit_cast<uint32_t>(a) & 0x7FFF'FFFFu) | (std::bit_cast<uint32_t>(b) & 0x8000'0000u));
	}
...
// solution: add compiler voodoo that automatically adds the special function arguments and loads these arguments in places
...
#define SUB_GROUP_TYPES(F, P) \
	F(int32_t, "s.i32", P) F(uint32_t, "u.i32", P) F(float, "f32", P) \
	F(int16_t, "s.i16", P) F(uint16_t, "u.i16", P) F(half, "f16", P)
#define SUB_GROUP_FUNC(type, type_str, func) type func(type, uint16_t lane_idx_delta_or_mask) \
	__attribute__((noduplicate, convergent)) asm("air." #func "." type_str);
...
int16_t sub_group_reduce_add(int16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_sum.s.i16");
uint16_t sub_group_reduce_add(uint16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_sum.u.i16");
half sub_group_reduce_add(half value) __attribute__((noduplicate, convergent)) asm("air.simd_sum.f16");
...
int16_t sub_group_reduce_min(int16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_min.s.i16");
uint16_t sub_group_reduce_min(uint16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_min.u.i16");
half sub_group_reduce_min(half value) __attribute__((noduplicate, convergent)) asm("air.simd_min.f16");
...
int16_t sub_group_reduce_max(int16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_max.s.i16");
uint16_t sub_group_reduce_max(uint16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_max.u.i16");
half sub_group_reduce_max(half value) __attribute__((noduplicate, convergent)) asm("air.simd_max.f16");
...
int16_t sub_group_inclusive_scan_add(int16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_prefix_inclusive_sum.s.i16");
uint16_t sub_group_inclusive_scan_add(uint16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_prefix_inclusive_sum.u.i16");
half sub_group_inclusive_scan_add(half value) __attribute__((noduplicate, convergent)) asm("air.simd_prefix_inclusive_sum.f16");
...
int16_t sub_group_exclusive_scan_add(int16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_prefix_exclusive_sum.s.i16");
uint16_t sub_group_exclusive_scan_add(uint16_t value) __attribute__((noduplicate, convergent)) asm("air.simd_prefix_exclusive_sum.u.i16");
half sub_group_exclusive_scan_add(half value) __attribute__((noduplicate, convergent)) asm("air.simd_prefix_exclusive_sum.f16");
...
requires (fl::device_info::has_fixed_known_simd_width() &&
		  ext::is_same_as_any_v<T, int16_t, uint16_t, half, int32_t, uint32_t, float>)
