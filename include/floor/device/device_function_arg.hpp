...
struct device_function_arg {
	...
	constexpr device_function_arg(const std::vector<device_buffer*>* bufs) noexcept : var(bufs) {}
	constexpr device_function_arg(const std::vector<device_buffer*>& bufs) noexcept : var(&bufs) {}
	
	constexpr device_function_arg(const std::vector<std::shared_ptr<device_buffer>>* bufs) noexcept : var(bufs) {}
	constexpr device_function_arg(const std::vector<std::shared_ptr<device_buffer>>& bufs) noexcept : var(&bufs) {}
	...
	constexpr device_function_arg(const std::vector<device_image*>* imgs) noexcept : var(imgs) {}
	constexpr device_function_arg(const std::vector<device_image*>& imgs) noexcept : var(&imgs) {}
	
	constexpr device_function_arg(const std::vector<std::shared_ptr<device_image>>* imgs) noexcept : var(imgs) {}
	constexpr device_function_arg(const std::vector<std::shared_ptr<device_image>>& imgs) noexcept : var(&imgs) {}
	...
	template <typename derived_buffer_t> requires std::is_convertible_v<derived_buffer_t*, device_buffer*>
	constexpr device_function_arg(const derived_buffer_t* buf) noexcept : var((const device_buffer*)buf) {}
	template <typename derived_buffer_t> requires std::is_convertible_v<derived_buffer_t*, device_buffer*>
	constexpr device_function_arg(const derived_buffer_t& buf) noexcept : var((const device_buffer*)&buf) {}
	
	template <typename derived_image_t> requires std::is_convertible_v<derived_image_t*, device_image*>
	...
	std::variant<const void*, // generic arg
			...
			const std::vector<device_buffer*>*, // array of buffers
			const std::vector<std::shared_ptr<device_buffer>>*, // array of buffers
			const device_image*, // single image
			const std::vector<device_image*>*, // array of images
			const std::vector<std::shared_ptr<device_image>>*, // array of images
